...
equiz:	equiz.h equi_minerz.h equi_minerz.cpp Makefile
	@echo Building equiz
	$(GPP) -g -std=c++11 -DLOGSPARK -DSPARKSCALE=11 equi_minerz.cpp -o equiz -lsodium
	
equi210:	equi210.h equi_miner210.h equi_miner210.cpp Makefile
